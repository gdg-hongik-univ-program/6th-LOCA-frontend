...
export default function MapPage() {
  return (
    <AppShell flush>
      <section className="absolute inset-x-0 top-0 z-10 px-5 pt-5">
        <div className="flex items-center gap-3 rounded-2xl bg-white px-4 py-3 shadow-[0_12px_30px_rgba(0,0,0,0.08)]">
