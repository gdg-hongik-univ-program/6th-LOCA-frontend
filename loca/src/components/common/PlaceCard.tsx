...
export function PlaceCard({ place, compact = false }: PlaceCardProps) {
  return (
    <Link className="card-shadow block overflow-hidden rounded-2xl bg-white" href={`/place/${place.id}`}>
      ...
      <div className="p-4">
        <h3 className="text-base font-extrabold text-[var(--text)]">{place.name}</h3>
