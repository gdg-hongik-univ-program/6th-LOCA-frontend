const paths = {
  ...
  search: [
    "M10.8 18.6a7.8 7.8 0 1 1 0-15.6 7.8 7.8 0 0 1 0 15.6Z",
    "M16.5 16.5 21 21",
  ],
  ...
  heart: [
    "M20.8 8.2c0 5-8.8 10.3-8.8 10.3S3.2 13.2 3.2 8.2A4.7 4.7 0 0 1 12 5.9a4.7 4.7 0 0 1 8.8 2.3Z",
  ],
  sliders: ["M4 7h10", "M18 7h2", "M4 17h2", "M10 17h10", "M14 5v4", "M8 15v4"],
  star: [
    "M12 3.5 14.7 9l6.1.9-4.4 4.3 1 6.1-5.4-2.9-5.4 2.9 1-6.1L3.2 9l6.1-.9L12 3.5Z",
  ],
  mapPin: [
  ...
  users: [
    ...
    "M2.5 20a5.5 5.5 0 0 1 11 0",
    "M12.5 20a5.5 5.5 0 0 1 9 0",
  ],
  camera: [
    "M4 8h4l1.5-2h5L16 8h4v11H4V8Z",
